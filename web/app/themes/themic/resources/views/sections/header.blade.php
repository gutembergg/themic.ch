<header class="banner">
  ...
  @if (has_nav_menu('primary_navigation'))
    <nav class="thePrimaryNavigation flex items-center justify-between flex-wrap bg-white w-full 
      ...
      <div class="z-10 flex items-center flex-shrink-0 text-white ml-6">
        <img src="@asset('images/logo_google.png')" alt="logo">
      </div>
      <div class="z-10 flex self-end lg:hidden mr-6">
      ...
      {!! wp_nav_menu(['theme_location' => 'primary_navigation', 'container_class' => 'theNavigationWrapper mr-6', 'menu_class' => 'nav flex theMobileNavigation', 'echo' => false]) !!}
    </nav> 
  @endif
</header>
